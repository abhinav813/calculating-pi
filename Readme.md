# Calculating pi
This is an implementation of a newly discovered formula for the calculation of pi.
...
The value of pi was correct to 10 decimal digits when summing the first 30 terms with &lambda; = 10.
